...
The remote options are untested since I don't have a Hyper-V instance available right now. They we're originally only implemented for demonstration purposes so I don't know if authentication and parameter validation actually work. Feel free to modify them though. :)
